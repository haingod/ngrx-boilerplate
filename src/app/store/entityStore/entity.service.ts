...
export class EntityService {
  constructor(private store: Store<any>, private actions: any, private selectors: any) {}
  // Connect select to store
  public getAll() {
    return this.store.select(this.selectors.items).pipe(map(item => item && item.toJS()));
  }
